  ...
  return (
    ...
    <div className='container '>
      <div className='row justify-content-center '>
        ...
        {success && <div className='alert alert-primary'>Registration Successful</div>}
            {loading ?( <button type='submit' className='btn btn-info d-block mx-auto mb-4' disabled><FontAwesomeIcon icon={faSpinner} spin/>Please Wait..</button>):
